...
function Chum(props) {
  return external_react_default.a.createElement("div", null, "Chum1");
}

function ChumList(props) {
  return external_react_default.a.createElement("table", null);
}
...
function (_React$Component) {
  ...
  function Main(props) {
    ...
    _defineProperty(main_assertThisInitialized(main_assertThisInitialized(_this)), "locationSwitchHandler", function () {
      if (_this.state.isLocating) {
        clearInterval(_this.state.intervalNumber);
  ...
  main_createClass(Main, [{
    ...
    value: function render() {
      ...
      })), external_react_default.a.createElement("p", null, "Latitude: ", this.state.lat), external_react_default.a.createElement("p", null, "Longitude: ", this.state.lon), external_react_default.a.createElement("p", null, "Accuracy: ", this.state.acc), external_react_default.a.createElement("p", null, "Zip Code: ", this.state.zip));
    }
  }]);
